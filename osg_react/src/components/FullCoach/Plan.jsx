const Plan = ({ name, cost, lessons_count, imageUrl, description, onClick, buttonLabel }) => {
	return (
		<div className="inline-block p-4 sm:p-8 space-y-6 sm:space-y-12 text-center bg-black min-w-[240px] max-w-[400px] rounded-3xl">
			...
			<p className="text-lg text-white sm:text-xl">{description}</p>
			<button
